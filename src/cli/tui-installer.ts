...
p.log.info("Anonymous telemetry is disabled by default. Enable with HECATEQ_SEND_ANONYMOUS_TELEMETRY=1 and HECATEQ_POSTHOG_KEY=.... Legacy OMO_SEND_ANONYMOUS_TELEMETRY, OMO_DISABLE_POSTHOG, and POSTHOG_API_KEY also work.")
